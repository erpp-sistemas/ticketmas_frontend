...
const ItemTicket: React.FC<TicketData> = ({data,openTicket}) => {
    ...
    return (
        <div className={`${themeItemStyles[theme]} mx-auto xl:mx-[.5%]  my-1 px-3 py-2 rounded-md w-[32.3%] min-w-[310px]  max-h-[200px] h-[200px]  inline-table  `}>
            ...
            <span className='mt-auto w-full'>
                ...
                <div className='flex justify-between '>
                    ...
                    <span>
                        <button onClick={()=>openTicket(data.id)} className='bg-primary px-3 py-1 rounded-md text-white ' >
                            Ver Completo
                        </button>
                    </span>
                </div>
